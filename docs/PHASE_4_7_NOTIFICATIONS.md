...
- Customer: realtime order-status UI already reflects kitchen updates, now with explicit ready callout
- duplicate admin event toasts are suppressed per event state
