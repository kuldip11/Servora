...
5. Billing & Payments _(write conservatively — see `04 §3`)_
6. Staff & Roles
7. Inventory
8. Analytics & Reports
9. Multi-Branch
10. Security & Reliability _(write conservatively — see `04 §3`)_
...
Correctly sequenced last — per `06 §4`, these pages should link _into_ the
