...
export const tableFormSchema = z.object({
  name: z.string().trim().min(1, 'Table name is required').max(50, 'Table name must be 50 characters or fewer'),
  capacity: z.string().min(1, 'Capacity is required').refine((value) => {
