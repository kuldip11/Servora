  ...
  .refine(
    (value) =>
      value.billingMode === "PER_COVER"
        ? value.coverCount !== undefined &&
          value.perCoverPriceRuleId !== undefined
        : value.coverCount === undefined &&
          value.perCoverPriceRuleId === undefined,
    {
      message:
        "PER_COVER orders require coverCount and perCoverPriceRuleId; LINE_ITEMS orders must omit them",
    },
  );
...
export type UpdateKitchenTicketStatusInput = z.infer<
