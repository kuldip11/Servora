...
import { MenuItemContent, menuItemClasses, OverlayHeader, overlayPanelClasses } from '../shared';

describe('overlay shared', () => {
  it('renders common menu and header primitives', () => {
    render(<><OverlayHeader title="Dialog" onClose={() => {}} /><MenuItemContent label="Save" shortcut="⌘S" onSelect={() => {}} /></>);
