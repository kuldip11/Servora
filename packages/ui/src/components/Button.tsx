...
export const BUTTON_VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary: 'bg-primary text-primary-foreground hover:bg-primary-hover active:bg-primary-hover focus:ring-primary',
  secondary:
  ...
  ghost: 'bg-transparent text-text-secondary hover:bg-surface-secondary focus:ring-border',
  link: 'bg-transparent text-primary hover:underline underline-offset-4 p-0 h-auto focus:ring-primary',
  danger: 'bg-danger text-danger-foreground hover:opacity-90 active:opacity-80 focus:ring-danger',
  success: 'bg-success text-success-foreground hover:opacity-90 active:opacity-80 focus:ring-success',
};
