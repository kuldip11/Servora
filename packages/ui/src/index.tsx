...
export type { MenuEntry, MenuItemDef, MenuSeparatorDef } from './components/overlay/shared';
...
export type { Column, ColumnAlign, SortDirection, SortState, TableDensity } from './components/data/shared';
