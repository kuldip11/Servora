...
export const ALL_ORDER_TYPES = [
  { value: 'DINE_IN' as const, label: 'Dine In', capabilityKey: 'dineInEnabled' as const },
  { value: 'TAKEAWAY' as const, label: 'Takeaway', capabilityKey: 'takeawayEnabled' as const },
  { value: 'DELIVERY' as const, label: 'Delivery', capabilityKey: 'deliveryEnabled' as const },
];
