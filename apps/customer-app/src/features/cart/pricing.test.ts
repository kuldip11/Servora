...
describe("cart pricing", () => {
  it("includes variants and modifiers in the line subtotal", () => {
    const line = { item, quantity: 2, variantId: "large", selectedOptions: [{ optionId: "cheese", quantity: 1 }] };
  ...
  it("creates stable keys independent of option order", () => {
    const first = { item, variantId: "large", selectedOptions: [{ optionId: "cheese", quantity: 1 }, { optionId: "sauce", quantity: 1 }] };
    const second = { item, variantId: "large", selectedOptions: [{ optionId: "sauce", quantity: 1 }, { optionId: "cheese", quantity: 1 }] };
