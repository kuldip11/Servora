...
export const CartView = memo(function CartView({ cart, subtotal, tax, total, table, onBack, onChange, onPlace, loading }: { cart: CartLine[]; subtotal: number; tax: number; total: number; table: string; onBack: () => void; onChange: (index: number, delta: number) => void; onPlace: () => void; loading: boolean }) {
  return (
