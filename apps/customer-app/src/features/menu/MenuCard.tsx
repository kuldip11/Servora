...
export const MenuCard = memo(function MenuCard({ item, onSelect }: { item: CustomerMenuItem; onSelect: (item: CustomerMenuItem) => void }) {
      ...
      >
        ...
        <div className="min-w-0 flex-1 py-3 pr-3 sm:py-4">
          ...
          <div className="mt-3 flex items-center justify-between gap-3">
            <span className="text-xs text-text-secondary">{item.modifierGroupLinks.length || item.variants.length ? "Customizable" : "Ready to order"}</span>
