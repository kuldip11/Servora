...
export const menuModifiersRouter = new Elysia({ prefix: '/api/menu' })
  ...
  .patch(
    '/modifier-groups/:id',
    ({ auth, params, body }) => modifierController.updateGroup(auth, params.id, body),
  ...
  .delete('/modifier-groups/:id', ({ auth, params }) => modifierController.deleteGroup(auth, params.id), {
    params: modifierGroupIdParams,
  })
  .patch(
    '/modifier-options/:id/availability',
    ({ auth, params, body }) => modifierController.setOptionAvailability(auth, params.id, body.isAvailable),
  ...
  .delete('/tags/:id', ({ auth, params }) => modifierController.deleteTag(auth, params.id), {
    params: tagIdParams,
  })
