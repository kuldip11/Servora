...
export const bulkOpsController = {
  async updateItemsStatus(
    ...
    const result = await bulkOpsService.updateItemsStatus(
      auth,
      itemIds,
      status,
      reason,
  ...
  async updateItemsCategory(
    ...
    const result = await bulkOpsService.updateItemsCategory(
      auth,
      itemIds,
      categoryId,
    );
  ...
  async bulkSetItemTags(
    ...
    const result = await bulkOpsService.bulkSetItemTags(
      auth,
      itemIds,
      tagIds,
      mode,
  ...
  async bulkSetItemModifierGroups(
    ...
    const result = await bulkOpsService.bulkSetItemModifierGroups(
      auth,
      itemIds,
      modifierGroupIds,
      mode,
  ...
  async bulkUpdatePrice(
    ...
    const result = await bulkOpsService.bulkUpdatePrice(
      auth,
      itemIds,
      priceChange,
      mode,
