...
const unit = t.Union([t.Literal("KG"), t.Literal("GRAMS"), t.Literal("LITERS"), t.Literal("ML"), t.Literal("PIECES"), t.Literal("PACKETS")]);
const ingredient = t.Object({
  inventoryItemId: t.Optional(t.Union([t.String({ format: "uuid" }), t.Null()])),
  ingredientSubRecipeId: t.Optional(t.Union([t.String({ format: "uuid" }), t.Null()])),
