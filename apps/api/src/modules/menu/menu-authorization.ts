...
export type MenuPermission = 'menu:read' | 'menu:create' | 'menu:update' | 'menu:delete' | 'menu:publish';

/** API-boundary authorization for all menu sub-routers. */
export function requireMenuPermission(auth: AuthContext, permission: MenuPermission): void {
 ...
 */
export function resolveMenuBranch(auth: AuthContext, requestedBranchId?: string | null): string | undefined {
...
export function assertMenuQueryBranch(auth: AuthContext, requestedBranchId?: string | null): string | undefined {
