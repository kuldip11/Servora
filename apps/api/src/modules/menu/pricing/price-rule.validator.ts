...
export const createPriceRuleBody = t.Object({
  ...
  menuItemSku: t.Optional(t.Union([t.String({ minLength: 1, maxLength: 50 }), t.Null()])),
  customerGroupId: t.Optional(t.Union([t.String({ format: "uuid" }), t.Null()])),
  coverTier: t.Optional(t.Union([t.Literal("ADULT"), t.Literal("CHILD"), t.Null()])),
  ...
  startTime: t.Optional(t.String({ pattern: "^([01]\\d|2[0-3]):[0-5]\\d(:[0-5]\\d)?$" })),
  endTime: t.Optional(t.String({ pattern: "^([01]\\d|2[0-3]):[0-5]\\d(:[0-5]\\d)?$" })),
...
export const listPriceRulesQuery = t.Object({ menuItemId: t.Optional(t.String()), organizationId: t.Optional(t.String({ format: "uuid" })), menuItemSku: t.Optional(t.String()) });
