...
export function requireKitchenPermission(auth: AuthContext, permission: KitchenPermission): void {
...
export function assertKitchenTicketAccess(auth: AuthContext, resourceBranchId: string): void {
  if (auth.tenantWide) {
