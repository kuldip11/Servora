...
export const organizationLoyaltyTierParams = t.Object({ id: t.String({ format: "uuid" }), tierId: t.String({ format: "uuid" }) });

export const organizationMenuParams = t.Object({ id: t.String({ format: "uuid" }), menuId: t.String({ format: "uuid" }) });
