...
export const tableNotFound = (id?: string): NotFoundError => {
  return new NotFoundError("Table", id);
};

export const branchNotFound = (branchId: string): NotFoundError => {
  return new NotFoundError("Branch", branchId);
};

export const branchRequiredForTable = (): MissingBranchError => {
  return new MissingBranchError(
    "Please select a specific branch before adding a table.",
  );
};

export const tablesDisabledForBranch = (): ConflictError => {
...
export const tableHasActiveOrder = (): ConflictError => {
  return new ConflictError(
...
export const tableHasOpenOrder = (): ConflictError => {
  return new ConflictError(
