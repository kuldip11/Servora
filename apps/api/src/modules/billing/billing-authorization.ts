...
export function requireBillingPermission(auth: AuthContext, permission: string): void {
...
export function assertBillingResourceAccess(auth: AuthContext, resourceBranchId: string): void {
  if (auth.tenantWide) {
