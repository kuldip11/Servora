...
export function TicketFooter({ next, nextLabel, btnClass, isUpdating, onAdvance }: Props) {
  if (!next) {
    return <p className="text-center text-xs text-text-secondary py-2">Waiting for waiter to serve</p>;
  }
