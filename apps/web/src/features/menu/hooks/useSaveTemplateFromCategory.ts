...
import { menuTemplatesService, type SaveTemplateInput } from '../services/menu-templates.service';
import { menuKeys } from '../query-keys';

export function useSaveTemplateFromCategory() {
  return useMutation({
    mutationFn: ({ categoryId, input }: { categoryId: string; input: SaveTemplateInput }) =>
