...
export const ProfilePage = () => {
  ...
  const profileMutation = useMutation({
    ...
    onError: (error) => notifyError(error, "Could not update profile"),
  });
  const passwordMutation = useMutation({
    ...
    onError: (error) => notifyError(error, "Could not change password"),
  });
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          >
            ...
            <Input label="Phone (optional)" {...profile.register("phone")} />
            <Input
              label="Profile image URL (optional)"
              type="url"
              {...profile.register("profileImageUrl")}
            />
          ...
          <form
            ...
            onSubmit={password.handleSubmit((values) => {
              if (values.newPassword !== values.confirmPassword) {
                password.setError("confirmPassword", {
