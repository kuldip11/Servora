...
vi.mock("../../../features/branches/hooks/useBranches", () => ({ useBranches: () => useBranches() }));
...
beforeEach(() => {
  vi.clearAllMocks();
  useAuthStore.mockReturnValue({ memberships: [membership], membershipId: "m1", branchId: null, setContext });
...
describe("BranchSwitcher", () => {
  ...
  it("changes active branch context", () => {
    ...
    expect(setContext).toHaveBeenCalledWith({ membershipId: "m1", franchiseId: "t1", branchId: "b2" });
  });
});
