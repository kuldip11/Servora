...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/product/multi-branch" },
  openGraph: {
    title: "Multi-branch restaurant management software | Servora",
    description:
      "Manage branches, tenant context and role-aware workflows as your restaurant organization grows.",
    url: "/product/multi-branch",
    images: [
      {
        url: "/og?title=multi-branch",
        width: 1200,
        height: 630,
        alt: "Multi-Branch — Servora",
      },
    ],
  },
  twitter: {
