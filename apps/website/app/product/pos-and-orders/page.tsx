...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/product/pos-and-orders" },
  openGraph: {
    title: "Restaurant POS and order management | Servora",
    description:
      "Keep restaurant orders moving from the counter or table into one connected operational workflow.",
    url: "/product/pos-and-orders",
    images: [
      {
        url: "/og?title=pos-and-orders",
        width: 1200,
        height: 630,
        alt: "POS & Orders — Servora",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Keep restaurant orders moving from the counter or table into one connected operational workflow.",
    images: ["/og?title=pos-and-orders"],
  },
};
